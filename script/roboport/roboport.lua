...
factorissimo.build_roboport_upgrade = function(factory)
    ...
    if factory.building and factory.building.valid then
        local rotated_position = factorissimo.rotate_pos(factory.building.position, factory.layout.door_side)
    ...
    roboport = roboport or factory.inside_surface.create_entity {
        ...
        position = {-factory.layout.inside_energy_pos.x + factory.inside_pos.x, factory.layout.inside_energy_pos.y + factory.inside_pos.y},
        force = factory.force,
        quality = factory.quality,
    }
    ...
    storage = storage or factory.inside_surface.create_entity {
        ...
        position = {-factory.layout.overlays.inside_pos.x + factory.inside_pos.x, factory.layout.overlays.inside_pos.y + factory.inside_pos.y},
        force = factory.force,
        quality = factory.quality,
    }
