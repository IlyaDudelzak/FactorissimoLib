layout_generators = layout_generators or {}
...
local function extend(target_table, source_table)
...
extend(layout_generators, {
    ["space-platform-hub-building-tier-1"] = {
        name = "space-platform-hub-building-tier-1",
        tier = 4, -- Уменьшаем до Tier 2
        inside_size = 46, -- Соответствует factory-2
        outside_size = 12, -- Соответствует factory-2
        inside_door_x = 0,
        inside_door_y = 24, -- Соответствует factory-2
        outside_door_x = 0,
        outside_door_y = 6, -- Соответствует factory-2
        outside_energy_receiver_type = "factory-power-input-12", -- Соответствует factory-2
        outside_requester_chest = "factory-requester-chest-factory-2", -- Соответствует factory-2
        outside_ejector_chest = "factory-eject-chest-factory-2", -- Соответствует factory-2
        inside_energy_x = -4,
        inside_energy_y = 25, -- Соответствует factory-2
        overlay_x = 0,
        overlay_y = 5, -- Соответствует factory-2
        rectangles = layout_generators["factory-2"].rectangles, -- Копируем геометрию factory-2
        mosaics = layout_generators["factory-2"].mosaics, -- Копируем мозаику factory-2
        connection_tile = "factory-floor",
        connections = layout_generators["factory-2"].connections, -- Копируем подключения factory-2
        overlays = {
            outside_x = 0,
            outside_y = -1,
            outside_w = 12,
    ...
    -- *** НОВЫЙ ХАБ TIER 2 (ТЕПЕРЬ TIER 3) ***
    ["space-platform-hub-building-tier-2"] = { -- НОВОЕ ИМЯ
        name = "space-platform-hub-building-tier-2",
        tier = 4, -- Это Tier 3
        inside_size = 60, -- Соответствует factory-3
        outside_size = 16, -- Соответствует factory-3
        inside_door_x = 0,
        inside_door_y = 31, -- Соответствует factory-3
        outside_door_x = 0,
        outside_door_y = 8, -- Соответствует factory-3
        outside_energy_receiver_type = "factory-power-input-16", -- Соответствует factory-3
        outside_requester_chest = "factory-requester-chest-factory-3", -- Соответствует factory-3
        outside_ejector_chest = "factory-eject-chest-factory-3", -- Соответствует factory-3
        inside_energy_x = -4,
        inside_energy_y = 32, -- Соответствует factory-3
        overlay_x = 0,
        overlay_y = 7, -- Соответствует factory-3
        rectangles = layout_generators["factory-3"].rectangles, -- Копируем геометрию factory-3
        mosaics = layout_generators["factory-3"].mosaics, -- Копируем мозаику factory-3
        connection_tile = "factory-floor",
        connections = layout_generators["factory-3"].connections, -- Копируем подключения factory-3
        overlays = {
            outside_x = 0,
            outside_y = -1,
            outside_w = 16,
...
--[[
/c __factorissimo-3-space-factory__ reload_layouts()
--]]
