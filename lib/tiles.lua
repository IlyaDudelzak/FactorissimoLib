...
if data then
    ...
    function M.createColoredTile(type, color, forced_name, forced_mask)
        ...
        tile.collision_mask = forced_mask or ((type == "factory-wall") and wall_mask() or floor_mask())
        data:extend({tile})
        return name
    end

    M.createColoredTile("factory-floor", {r=0.55, g=0.55, b=0.55}, "factory-floor")
    M.createColoredTile("factory-floor", {r=0.55, g=0.55, b=0.55}, "factory-entrance-floor", entrance_mask())
