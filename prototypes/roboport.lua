...
roboport.icon = "__FactorissimoLib__/graphics/icon/construction-chest.png"
...
storage_chest.icon = "__FactorissimoLib__/graphics/icon/construction-chest.png"
storage_chest.icon_size = 64
storage_chest.subgroup = "factorissimo-roboports"
...
storage_chest.animation.layers[1].filename = "__FactorissimoLib__/graphics/entity/construction-chest.png"
...
for _, prototype in pairs(entities_to_extend) do
    ...
    prototype.subgroup = "factorissimo-roboports"
end
...
data:extend {{
    ...
    subgroup = "factorissimo-roboports",
...
data:extend {{
    ...
    icon = "__FactorissimoLib__/graphics/icon/construction-chest.png",
    icon_size = 64,
    stack_size = 1,
    hidden = true,
    hidden_in_factoriopedia = true,
