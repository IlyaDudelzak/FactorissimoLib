...
data:extend{{
    ...
    filename = "__FactorissimoLib__/graphics/icon/factory-floor-space.png",
    width = 64,
    height = 64,
    scale = 1,
    flags = {"gui-icon"},
...
for _, planet in pairs(data.raw.planet) do
    if planet.name:find("%-factory%-floor$") then goto continue end
    ...
    factory_floor.localised_name = {"factorissimo.factory-floor-name", original_localised_name}
    ...
    factory_floor.subgroup = "factorissimo-factory-floors"
    ...
    if planet.name == "nauvis" then
        ...
        factory_floor.starmap_icon_size = 512
    end
